              ...
              <b-input-group>
                ...
                <b-input-group-append>
                  <b-button
                    ...
                    size="sm"
                    :to="{ name: 'updateCommercialUsers', params: { id: row.item.id } }"
            ...
            >
              <b-card-text>
                <b-row class="border-bottom">
                  ...
                  <b-col cols="10">
                    {{ row.item.createdAt | moment("DD/MM/YYYY") }}
                  </b-col>
                </b-row>
                <b-row class="border-bottom">
                  <b-col cols="2">
                ...
                <b-row class="border-bottom">
                  ...
                  <b-col cols="10">
                    {{ row.item.company.company_registration_number }}
                  </b-col>
                </b-row>
                <b-row class="border-bottom">
                  <b-col cols="2">
                  ...
                  <b-col cols="10">
                    {{ row.item.company.vat }}
                  </b-col>
                </b-row>
                <b-row class="border-bottom">
                  <b-col cols="2">
                    <strong>Owner Naem</strong>
                  </b-col>
                  <b-col cols="10">
                ...
                <b-row class="border-bottom">
                  ...
                  <b-col cols="10">
                    {{ row.item.company.position_in_company }}
                  </b-col>
                </b-row>
                <b-row class="border-bottom">
                  <b-col cols="2">
                  ...
                  <b-col cols="10">
                    {{ row.item.company.building_name }}
                  </b-col>
                </b-row>
                <b-row class="border-bottom">
                  <b-col cols="2">
                ...
                <b-row class="border-bottom">
                  ...
                  <b-col cols="10">
                    {{ row.item.company.company_address }}
                  </b-col>
                </b-row>
              </b-card-text>
            </b-col>
...
export default {
  ...
  methods: {
    ...
    getDocuments() {
      ...
      axios
        .get(`/users/get_all_commercial_users/${this.page}/${this.searchTerm}`)
