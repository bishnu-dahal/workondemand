...
export default {
  ...
  methods: {
    Submit() {
      ...
      axios
        .post('/slider/update_slider', this.formValues)
        .then(response => {
    ...
    getSliderById() {
      ...
      const appendWithurl = `slider/get_slider_by_id/${this.$route.params.id}`
      axios.get(appendWithurl).then(response => {
        console.log(response.data)
        this.formValues = response.data.data
        this.getCategoryDetail(this.formValues.category_id)
        this.initTrHeight()
        console.log('Category Fetched')
      }).catch(error => {
        console.error(error)
    ...
    getCategoryDetail(id) {
      console.log(this.$route.params.id)
      const appendWithurl = `categories/getCategoryById/${id}`

      axios.get(appendWithurl).then(response => {
        this.formValues.categoty = response.data.data.title
