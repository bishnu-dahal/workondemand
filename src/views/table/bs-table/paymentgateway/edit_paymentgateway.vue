...
export default {
  ...
  methods: {
    Submit() {
      ...
      axios
        .post(`/paymentgateway/update_payment_gateways/${this.$route.params.id}`, this.formValues)
        .then(response => {
    ...
    getPaymentGateWay() {
      const appendWithurl = `paymentgateway/getPaymentGatewayById/${this.$route.params.id}`
