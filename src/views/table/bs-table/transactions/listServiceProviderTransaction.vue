...
export default {
  ...
  data() {
    return {
      ...
      {
        key: 'service_provider.first_name',
        label: 'First Name',
        sortable: true,
        thClass: 'customHead',
      },
      {
        key: 'service_provider.last_name',
        label: 'Last Name',
        sortable: true,
        thClass: 'customHead',
      },
  ...
  methods: {
    ...
    getDocuments() {
      ...
      axios
        .post(`/serviceProvider/admin_get_all_serviceProvider_transactions/${this.page}/${this.searchTerm}`,
          this.formValues)
        .then(response => {
