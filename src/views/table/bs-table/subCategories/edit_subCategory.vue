...
export default {
  ...
  methods: {
    Submit() {
      ...
      axios
        .post('/subcategories/update_subCategories', this.formValues)
        .then(response => {
    ...
    getCategoryDetail() {
      ...
      const appendWithurl = `categories/getCategoryById/${this.formValues.category_id}`
    ...
    getsubCategory() {
      console.log(this.$route.params.id)
      const appendWithurl = `subcategories/get_subCategories_id/${this.$route.params.id}`
